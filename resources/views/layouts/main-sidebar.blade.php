                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('invoices.Invoice_Paid') }}">الفواتير المدفوعة</a>
                            @endcan

                        </li>

                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('invoices.Invoice_unPaid') }}">الفواتير
                                    الغيرمدفوعة</a>
                            </li>
                        @endcan

                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('invoices.Invoice_Partial') }}">الفواتير المدفوعة
                                    جزئيا</a>
                            </li>
                        @endcan
