                        ...
                        <div class="d-flex">
                            <div class="">
                                <h3 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format($count_unpaid_sum, 2) }}
                                ...
                                <span class="text-white op-7">
                                    ...
                                    @php
                                        ...
                                        if ($count_all == 0) {
                                            ...
                                            echo round(($count_unpaid / $count_all) * 100, 2);
                                        }
                                    @endphp %
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format($count_paid_sum, 2) }}
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        if ($count_all == 0) {
                                            ...
                                            echo round(($count_paid / $count_all) * 100, 2);
                                        }
                                    @endphp %
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format($count_partially_paid_sum, 2) }}
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        if ($count_all == 0) {
                                            ...
                                            echo round(($count_partially_paid / $count_all) * 100, 2);
                                        }
                                    @endphp %
                                </span>
                            </span>
